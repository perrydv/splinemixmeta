...
#' @param type Type of predictions. This can be "outcome" or "residual" and will be passed to the `type` argument of [blup.splinemixmeta()].
...
#'
#' @details This is a convenience function that calls `blup` (i.e. `blup.splinemixmeta`) without requiring one to know which random-effects "levels"
